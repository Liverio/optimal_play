...
def simulate(P1_call_freq, P2_bluff_freq, P2_bet_size, pot_size, sims):
    # Cumulative EV
    EV = [0, 0]
    ...
    for sims in range(0, sims):
        ...
        # -- Players' outcome --
        # ----------------------
        outcome_P1 = outcome(P1, hand[P1], action_P1, hand[P2], action_P2, pot_size, P2_bet_size)
        outcome_P2 = outcome(P2, hand[P1], action_P1, hand[P2], action_P2, pot_size, P2_bet_size)
